...
public:
	...
	const std::map<const Ship *, int> &GetDepreciatedShipSales() const;
	int DepreciatedShipSales(const Ship *ship) const;
	void RemoveDepreciatedShipSales(const Ship *ship);
